...
CKEDITOR.editorConfig = function( config ) {
	...
	config.plugins = 'basicstyles,blockquote,dialogui,dialog,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,elementspath,enterkey,entities,popup,filetools,filebrowser,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastetools,pastefromgdocs,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,tableselection,undo,lineutils,widgetselection,widget,notificationaggregator,uploadwidget,uploadimage,wsc,smiley,hkemoji,textwatcher,autocomplete,textmatch,xml,ajax,mentions';
...
config.toolbar = [
		...
		//{ name: 'insert', groups:['easyimage','smiley'],items: [ 'EasyImage', '-', 'Smiley' ] }
		'/',
	...
	config.removeButtons = 'Underline,Subscript,Superscript,tools';
