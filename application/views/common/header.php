                    ...
                    <div class="navbar-brand">
                        <a href="<?php echo base_url('admin') ?>" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <!-- <img src="<?php echo base_url() ?>assets/images/Logo.png" alt="homepage" class="dark-logo" /> -->
                                <!-- Light Logo icon -->
                            ...
                            <span class="logo-text">
                                <img src="<?php echo base_url() ?>assets/images/Logo.png" alt="homepage" class="dark-logo" style="width:100%" />
                                <img src="<?php echo base_url() ?>assets/images/Logo.png" class="light-logo" alt="homepage" style="height: 57px" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
